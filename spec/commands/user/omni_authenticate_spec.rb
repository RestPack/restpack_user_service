...
describe Commands::User::User::OmniAuthenticate do
  is_required :application_id, :omniauth_response
  is_optional :user_id

  User = Models::User::User
  Authentication = Models::User::Authentication
  ...
  context 'existing user' do
    ...
    context 'existing authentication' do
      it 'returns the existing user' do
        ...
        response.result.should == Serializers::User::User.resource(@authentication.user)
      end
    end
